...
// void main(void)
{
  ...
  // Remove File extension from first argument for 
  var ppPath = WScript.Arguments(1);
  var fin, fout;

  switch (ppType) {
  case "ProdUBL":
    // If ppPath was given with extension remove it
    if ( ppPath.indexOf(".sim") !== -1){
      ppPath = ppPath.slice(0,-4);
    }
